...
let rec inner_extract e1 l2 = match l2 with
	| [] -> []
	| h::t -> 
	     (if (get_termtype e1 = "equality") && (get_termtype h = "equality")
	     then List.append (find_intersection (get_value e1) (get_varlist e1) "equality" (get_value h) (get_varlist h) "equality" 0) (inner_extract e1 t)
	     else if get_termtype e1 = "equality"
		then List.append (find_intersection (get_value e1) (get_varlist e1) "equality" (get_predname h) (get_varlist h) (get_termtype h) 0) (inner_extract e1 t)	
	     else if get_termtype h = "equality"
	     then List.append (find_intersection (get_predname e1) (get_varlist e1) (get_termtype e1) (get_value h) (get_varlist h) "equality" 0) (inner_extract e1 t)
